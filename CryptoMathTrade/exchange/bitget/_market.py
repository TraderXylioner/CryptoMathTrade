...
class Market(API):
    def get_depth(self, symbol: str, limit: int = 150, type: str = None) -> Response[OrderBook, object]:
        """Get orderbook.
...
class AsyncMarket(API):
    async def get_depth(self, symbol: str, limit: int = 150, type: str = None) -> Response[OrderBook, object]:
        """Get orderbook.
