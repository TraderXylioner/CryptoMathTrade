...
class Market(API):
    ...
    def get_trades(self, symbol: str, limit: int = 500) -> Response[list[Trade], object]:
        """Recent Trades List
    ...
    def get_ticker(self, symbol: str = None, symbols: list = None) -> Response[list[Ticker], object]:
        ...
        """
        response = validate_response(self._query(**MarketCore.get_ticker(self, symbol=symbol, symbols=symbols)))
        json_data = response.json()
        return _deserialize_ticker(json_data, response)

    def get_symbols(self, symbol: str = None, symbols: list = None) -> Response[list[Symbol], object]:
        """Query Symbols
        ...
        params:
            ...
            symbols (list, optional): list of trading pairs.
        """
        response = validate_response(self._query(**MarketCore.get_symbols(self, symbol=symbol, symbols=symbols)))
        json_data = response.json()
...
class AsyncMarket(API):
    async def get_depth(self, symbol: str, limit: int = 100) -> Response[OrderBook, object]:
        ...
        params:
            ...
            limit (int, optional): Default 100; max 5000.
        """
        response = validate_response(await self._async_query(**MarketCore.get_depth(self, symbol=symbol, limit=limit)))
        json_data = response.json
        return _deserialize_depth(json_data, response)

    async def get_trades(self, symbol: str, limit: int = 500) -> Response[list[Trade], object]:
        """Recent Trades List
        ...
        params:
            ...
            limit (int, optional): Default 500; max 1000.
        """
        response = validate_response(await self._async_query(**MarketCore.get_trades(self, symbol=symbol, limit=limit)))
        json_data = response.json
        return _deserialize_trades(json_data, response)

    async def get_ticker(self, symbol: str = None, symbols: list = None) -> Response[list[Ticker], object]:
        """24hr Ticker Price Change Statistics
        ...
        response = validate_response(
            await self._async_query(**MarketCore.get_ticker(self, symbol=symbol, symbols=symbols)))
        json_data = response.json
        return _deserialize_ticker(json_data, response)

    async def get_symbols(self, symbol: str = None, symbols: list = None) -> Response[list[Symbol], object]:
        """Query Symbols
        ...
        """
        response = validate_response(
            await self._async_query(**MarketCore.get_symbols(self, symbol=symbol, symbols=symbols)))
        json_data = response.json
        return _deserialize_symbols(json_data, response)
...
class WebSocketMarket(API):
    async def get_depth(self, symbol: str, limit: int = 20, interval: int = 1000) -> Response[OrderBook, object]:
