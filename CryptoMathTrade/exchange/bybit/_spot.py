...
#         """
#         return self._query(**new_order_args(self, symbol=symbol, side=side, old_type='MARKET', quantity=quantity,
...
#         """
#         return self._query(
#             **new_order_args(self, symbol=symbol, side=side, old_type='LIMIT', timeInForce=timeInForce, quantity=quantity,
#                              price=price))
